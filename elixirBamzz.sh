...
# ASCII Art Header
display_ascii() {
    echo -e "     _____                   _____                   _____                   _____                   _____          ${RESET}"
    echo -e "         /\    \                 /\    \                 /\    \                 /\    \                 /\    \         ${RESET}"
    echo -e "        /::\    \               /::\    \               /::\____\               /::\    \               /::\    \        ${RESET}"
    echo -e "       /::::\    \             /::::\    \             /::::|   |               \:::\    \              \:::\    \       ${RESET}"
    echo -e "      /::::::\    \           /::::::\    \           /:::::|   |                \:::\    \              \:::\    \      ${RESET}"
    ...
    echo -e "    /:::/__\:::\    \       /:::/__\:::\    \       /:::/|::|   |                  \:::\    \              \:::\    \    ${RESET}"
    echo -e "   /::::\   \:::\    \     /::::\   \:::\    \     /:::/ |::|   |                   \:::\    \              \:::\    \   ${RESET}"
    echo -e "  /::::::\   \:::\    \   /::::::\   \:::\    \   /:::/  |::|___|______              \:::\    \              \:::\    \  ${RESET}"
    echo -e " /:::/\:::\   \:::\ ___\ /:::/\:::\   \:::\    \ /:::/   |::::::::\    \              \:::\    \              \:::\    \ ${RESET}"
    echo -e "/:::/__\:::\   \:::|    /:::/  \:::\   \:::\____/:::/    |:::::::::\___________________\:::\___________________\:::\____\${RESET}"
    echo -e "\:::\   \:::\  /:::|____\::/    \:::\  /:::/    \::/    / ~~~~~/:::/    \::::::::::::::::::/    \::::::::::::::::::/    /${RESET}"
    echo -e " \:::\   \:::\/:::/    / \/____/ \:::\/:::/    / \/____/      /:::/    / \::::::::::::::::/____/ \::::::::::::::::/____/ ${RESET}"
    echo -e "  \:::\   \::::::/    /           \::::::/    /              /:::/    /   \:::\~~~~\~~~~~~        \:::\~~~~\~~~~~~       ${RESET}"
    echo -e "   \:::\   \::::/    /             \::::/    /              /:::/    /     \:::\    \              \:::\    \            ${RESET}"
    echo -e "    \:::\  /:::/    /              /:::/    /              /:::/    /       \:::\    \              \:::\    \           ${RESET}"
    echo -e "     \:::\/:::/    /              /:::/    /              /:::/    /         \:::\    \              \:::\    \          ${RESET}"
